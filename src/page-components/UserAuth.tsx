...
import { Building2, Video, ArrowLeft, Eye, EyeOff } from 'lucide-react';
  ...
  const demoAccounts = [
    {
      type: 'Brand',
      icon: Building2,
      email: 'brand@partnerscale.com',
      password: '12345678',
      user_type: 'brand' as const,
      description: 'Access brand dashboard to manage partnerships'
    },
    {
      type: 'Creator',
      icon: Video,
      email: 'creator@partnerscale.com',
      password: '12345678',
      user_type: 'creator' as const,
      description: 'Access creator portal for collaboration opportunities'
    }
  ];

  const fillDemoCredentials = (email: string, password: string, type: 'brand' | 'creator') => {
    setEmail(email);
